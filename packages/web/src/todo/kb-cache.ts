 ...
 *  (a manual reload) is what actually exercises the change. Called once from
 ...
 *  code runs before the settings dialog exists in the DOM). */
export function initClearCacheButton() {
