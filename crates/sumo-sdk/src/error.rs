...
pub enum SdkError {
    ...
    Persist(#[source] sumo_kb::PromoteError),
...
#[cfg(feature = "persist")]
impl From<sumo_kb::PromoteError> for SdkError {
    fn from(e: sumo_kb::PromoteError) -> Self {
        SdkError::Persist(e)
    }
}
