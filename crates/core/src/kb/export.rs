...
#[cfg(feature = "cnf")]
fn format_cnf_literal(store: &SyntacticLayer, lit: &crate::types::CnfLiteral) -> String {
...
#[cfg(feature = "cnf")]
fn format_cnf_term(store: &SyntacticLayer, term: &crate::types::CnfTerm) -> String {
