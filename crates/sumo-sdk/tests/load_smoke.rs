...
fn progress_callback_emits_promote_events() {
    ...
    impl sumo_sdk::ProgressSink for Sink {
        fn emit(&self, e: &sumo_sdk::ProgressEvent) {
            let label = match *e {
                sumo_sdk::ProgressEvent::LoadStarted     { .. } => "load-started",
                sumo_sdk::ProgressEvent::FileRead        { .. } => "file-read",
                sumo_sdk::ProgressEvent::SourceIngested  { .. } => "source-ingested",
                sumo_sdk::ProgressEvent::PromoteStarted  { .. } => "promote-started",
                sumo_sdk::ProgressEvent::PromoteFinished { .. } => "promote-finished",
                _ => "other",
            };
