...
//!
//!   cargo test -p sigmakee-rs-core --features "cnf integrated-prover persist" \
...
//! developer's machine.  Set env var `sigmakee_rs_core_DIR` (defaults to
...
use sigmakee_rs_core::{KnowledgeBase, TptpLang};
use sigmakee_rs_core::prover::VampireRunner;
