...
The SigmaKEE CLI provides the full SigmaKEE experience as a performant, command-line interface! The 
following document is a full end user's guide for using the CLI.
