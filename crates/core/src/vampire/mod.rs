// crates/core/src/vampire/mod.rs
//
// Vampire axiom cache for sigmakee-rs-core.
//
...
impl VampireAxiomCache {
    ...
    pub fn build(
        ...
        let mut conv = NativeConverter::new(translation, mode);
        ...
        crate::emit_event!(crate::progress::ProgressEvent::Log { level: crate::progress::LogLevel::Debug, target: "sigmakee_rs_core::vampire", message: format!("axiom cache built: mode={:?}, {} axiom(s), {} skipped", mode, sid_map.len(), skipped) });
...
impl VampireAxiomCacheSet {
    ...
    pub fn build(
        ...
        let tff = VampireAxiomCache::build(translation, axiom_ids, Mode::Tff);
        let fof = VampireAxiomCache::build(translation, axiom_ids, Mode::Fof);
