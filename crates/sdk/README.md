...
Programmatic Rust API over [`sigmakee-rs-core`](https://crates.io/crates/core): the
...
Full API reference at [docs.rs/sigmakee-rs-sdk](https://docs.rs/sigmakee-rs-sdk).
