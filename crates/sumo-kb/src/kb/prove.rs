...
impl KnowledgeBase {
    ...
    pub fn ask(
        ...
        let (problem, sid_map) = {
            ...
            let mut conv = NativeConverter::from_parts(
                &self.layer.store, &self.layer, seed_problem, seed_sid_map, mode,
            );
    ...
    pub fn ask_embedded(
        ...
        // see `crates/sumo-kb/src/prover/subprocess.rs::build_vampire_args`.
        //
    ...
    fn query_affects_taxonomy(&self, sids: &[SentenceId]) -> bool {
        self.layer.store.any_touches_taxonomy(sids)
    }
