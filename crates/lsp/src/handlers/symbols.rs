...
fn describe_sentence(
    ...
    sent: &sigmakee_rs_core::types::Sentence,
...
fn element_preview(kb: &sigmakee_rs_core::KnowledgeBase, el: &sigmakee_rs_core::types::Element) -> String {
    use sigmakee_rs_core::types::{Element, Literal};
    match el {
...
fn kb_sym_name(kb: &sigmakee_rs_core::KnowledgeBase, id: sigmakee_rs_core::SymbolId) -> String {
