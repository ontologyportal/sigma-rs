...
import { $, downloadText, isDarkTheme } from '../dom.js';
import { loadMonaco, diagsToMarkers } from '../editor/monaco.js';
import { proverConfig, vampireSelected } from '../prover-config.js';
import { wireProofGraph } from '../proof-graph.js';
import { renderProofSteps, proseDetails } from '../proof-view.js';
