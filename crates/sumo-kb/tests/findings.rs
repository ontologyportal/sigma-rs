...
use sumo_kb::error::{clear_promoted_errors, promote_to_error, set_all_errors};
...
/// classifies as a warning per `current_level()` — sumo-kb's default
...
fn validate_all_findings_default_mode_classifies_everything_as_warning() {
    ...
    // Without any promotion, sumo-kb's default classification is
