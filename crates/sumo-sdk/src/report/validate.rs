...
use sumo_kb::{KbError, SemanticError, SentenceId};
...
///
/// `sumo-kb` no longer auto-prints any semantic finding.  Every
/// finding from a validation pass lands in this report — pre-
/// classified by [`sumo_kb::SemanticError::is_warn`], which honours
