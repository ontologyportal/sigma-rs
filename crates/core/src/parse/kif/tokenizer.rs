// crates/core/src/parse/kif/tokenizer.rs
...
pub fn tokenize(src: &str, file: &str) -> (Vec<Token>, Vec<(Span, KifParseError)>) {
    ...
    crate::emit_event!(crate::ProgressEvent::Log { level: crate::LogLevel::Trace, target: "sigmakee_rs_core::tokenizer", message: format!("tokenized {} tokens, {} errors from '{}'", tokens.len(), errors.len(), file) });
    (tokens, errors)
}
